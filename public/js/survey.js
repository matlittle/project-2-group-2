...
function endSurvey() {
  ...
  $.ajax({
    ...
    if (res.chosenField === "Anxiety") {
      specId = 1;
    } else if (res.chosenField === "Depression"){
      specId = 2;
    } else if (res.chosenField === "ADHD") {
      specId = 3;
    } else {
      specId = 4;
    }
  
    window.location.href = (`https://kintsukuroi.herokuapp.com/resources/${specId}`);
  });
}
